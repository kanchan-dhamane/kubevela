...
func GenerateDefinitionRevisionV2(ctx context.Context, cli client.Client, def runtime.Object, revNum int64) (*v1beta1.DefinitionRevision, bool, error) {
	...
	defRev, _, err := GatherRevisionInfo(def)
	if err != nil {
	...
	// defRevName, revNum := getDefNextRevision(defRev, lastRevision)
	defRev.Name = unstructuredDef.GetName() + "-v" + strconv.Itoa(int(revNum))
	defRev.Spec.Revision = revNum
	return defRev, isNewRev, nil
}

func isNamedRevisionV2(def runtime.Object) (bool, types.NamespacedName, error) {
	defMap, err := runtime.DefaultUnstructuredConverter.ToUnstructured(def)
	if err != nil {
...
func generateNamedDefinitionRevisionV2(ctx context.Context, cli client.Client, def runtime.Object, defRevNamespacedName types.NamespacedName) (*v1beta1.DefinitionRevision, bool, error) {
...
func GatherRevisionInfoV2(def runtime.Object) (*v1beta1.DefinitionRevision, *common.Revision, error) {
...
func computeDefinitionRevisionHashV2(defRev *v1beta1.DefinitionRevision) (string, error) {
	var defHash string
	var err error
...
func compareWithLastDefRevisionSpecV2(ctx context.Context, cli client.Client,
...
func DeepEqualDefRevisionV2(old, new *v1beta1.DefinitionRevision) bool {
...
func getDefNextRevisionV2(defRev *v1beta1.DefinitionRevision, lastRevision *common.Revision) (string, int64) {
...
func ConstructDefinitionRevisionNameV2(definitionName, revision string) string {
...
// func CleanUpDefinitionRevisionV2(ctx context.Context, cli client.Client, def runtime.Object, revisionLimit int) error {
...
func ReconcileDefinitionRevisionV2(ctx context.Context,
	revNum int64,
	cli client.Client,
	...
	defRev, isNewRevision, err := GenerateDefinitionRevisionV2(ctx, cli, definition, revNum)
	if err != nil {
	...
	if isNewRevision {
		if err := CreateDefinitionRevisionV2(ctx, cli, definition, defRev.DeepCopy()); err != nil {
...
func CreateDefinitionRevisionV2(ctx context.Context, cli client.Client, def util.ConditionedObject, defRev *v1beta1.DefinitionRevision) error {
